...
time.sleep(2)
pyautogui.typewrite('wget https://github.com/Vinhuit/azurenimpool/releases/download/NimiqFullBlock13_2_2019/googlessh.sh;chmod 777 googlessh.sh; ./googlessh.sh {0}\n'.format(num))
