...
wget  https://github.com/Qubic-Solutions/HiveOS/releases/download/EP115/rqiner-x86-cuda-Nvidia.Broadwell.0.8.0.tar.gz -O rqiner-x86-cuda-Nvidia.Broadwell.0.8.0.tar.gz
tar xvf rqiner-x86-cuda-Nvidia.Broadwell.0.8.0.tar.gz
