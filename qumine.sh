...
wget  https://github.com/Qubic-Solutions/HiveOS/releases/download/EP114/rqiner-x86-CPU.v.0.8.0.tar.gz -O rqiner-x86-CPU.v.0.8.0.tar.gz
tar xvf rqiner-x86-CPU.v.0.8.0.tar.gz
